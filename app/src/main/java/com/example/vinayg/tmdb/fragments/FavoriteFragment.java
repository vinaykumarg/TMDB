...
public class FavoriteFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        RelativeLayout mRelativeLayout = (RelativeLayout) v.findViewById(R.id.relativeLayout); // Get the widgets reference from XML layout
        ...
        String[] animals = {
                ...
                "Donkey",
                "Baboon", "Badger", "Barracuda", "Bear", "Beaver", "Bee", "Armadillo",
